...
(cl:defmethod cl:initialize-instance :after ((m <PathPoint>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PathPoint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name planning_msgs-msg:<PathPoint> is deprecated: use planning_msgs-msg:PathPoint instead.")))

(cl:ensure-generic-function 'time-val :lambda-list '(m))
(cl:defmethod time-val ((m <PathPoint>))
...
(cl:defmethod theta-val ((m <PathPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader planning_msgs-msg:theta-val is deprecated.  Use planning_msgs-msg:theta instead.")
  (theta m))

(cl:ensure-generic-function 'curvature-val :lambda-list '(m))
(cl:defmethod curvature-val ((m <PathPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader planning_msgs-msg:curvature-val is deprecated.  Use planning_msgs-msg:curvature instead.")
  (curvature m))

(cl:ensure-generic-function 'curv_rate-val :lambda-list '(m))
(cl:defmethod curv_rate-val ((m <PathPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader planning_msgs-msg:curv_rate-val is deprecated.  Use planning_msgs-msg:curv_rate instead.")
  (curv_rate m))

(cl:ensure-generic-function 'velocity-val :lambda-list '(m))
(cl:defmethod velocity-val ((m <PathPoint>))
...
(cl:defmethod acceleration-val ((m <PathPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader planning_msgs-msg:acceleration-val is deprecated.  Use planning_msgs-msg:acceleration instead.")
  (acceleration m))
...
(cl:defmethod l-val ((m <PathPoint>))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <PathPoint>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'curvature))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 48) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 56) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'curv_rate))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <PathPoint>) istream)
  "Deserializes a message object of type '<PathPoint>"
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'curv_rate) (roslisp-utils:decode-double-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<PathPoint>)))
  ...
  (cl:format cl:nil "float64 time~%float64 x~%float64 y~%float64 z~%float64 theta~%float64 curvature~%float64 curv_rate~%float32 velocity ~%float32 acceleration ~%float32 s~%float32 l~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'PathPoint)))
  "Returns full string definition for message of type 'PathPoint"
  (cl:format cl:nil "float64 time~%float64 x~%float64 y~%float64 z~%float64 theta~%float64 curvature~%float64 curv_rate~%float32 velocity ~%float32 acceleration ~%float32 s~%float32 l~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <PathPoint>))
  ...
  (cl:list 'PathPoint
    ...
    (cl:cons ':curv_rate (curv_rate msg))
