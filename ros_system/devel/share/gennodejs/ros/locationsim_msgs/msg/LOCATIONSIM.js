...
// (in-package locationsim_msgs.msg)
...
class LOCATIONSIM {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('positon_yaw')) {
        this.positon_yaw = initObj.positon_yaw
      }
      else {
        this.positon_yaw = 0.0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [positon_yaw]
    bufferOffset = _serializer.float32(obj.positon_yaw, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [positon_yaw]
    data.positon_yaw = _deserializer.float32(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    const resolved = new LOCATIONSIM(null);
    ...
    if (msg.positon_yaw !== undefined) {
      resolved.positon_yaw = msg.positon_yaw;
    }
    else {
      resolved.positon_yaw = 0.0
    }
